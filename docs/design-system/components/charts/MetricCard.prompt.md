...
`MetricCard` menulis nilainya dengan `white-space: nowrap` — nominal rupiah tidak boleh terpecah dua baris. Karena itu track grid yang memuatnya minimal **240px** (`minmax(240px,1fr)`), bukan 200px: angka 24px butuh ~135px, ditambah padding kartu dan ikon.
